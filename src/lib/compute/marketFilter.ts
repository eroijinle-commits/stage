 ...
 */
export function flattenAllMarkets(groups: StakeGroupWithMarkets[]): StakeMarket[] {
  return groups.flatMap((g) => g.templates.flatMap((t) => t.markets));
}
 ...
 */
export function filterByOutcomeCount(markets: StakeMarket[], maxOutcomes: number): RankedMarket[] {
