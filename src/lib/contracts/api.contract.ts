...
export interface StakeFixtureCompetitor {
  name: string;
  defaultName: string;
  extId: string;
  countryCode?: string;
...
export interface StakeFixtureDataMatch {
  __typename: "SportFixtureDataMatch";
  startTime: string;
  isOutright: boolean;
  competitors: StakeFixtureCompetitor[];
  teams?: Array<{ extId: string; name: string; qualifier: string }>;
}
export interface StakeFixtureDataOutright {
  __typename: "SportFixtureDataOutright";
  name: string;
  startTime: string;
  endTime?: string;
  isOutright: boolean;
...
export interface StakeFixtureEventStatus {
  ...
  clock?: { matchTime: string; remainingTime?: string; stopped: boolean };
...
export interface StakeFixture {
  ...
  eventStatus?: StakeFixtureEventStatus;
  markets?: StakeMarket[];
}
export interface StakeSportGroup {
  name: string;
  translation: string;
  rank: number;
}
export interface StakeSportGroupTemplate {
  id: string;
  extId: string;
  rank: number;
  name: string;
...
export interface StakeGroupWithMarkets extends StakeSportGroup {
  templates: Array<StakeSportGroupTemplate & { markets: StakeMarket[] }>;
}
