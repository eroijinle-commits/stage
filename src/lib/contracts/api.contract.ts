...
export interface StakeFixture { id: string; name: string; slug: string; status: string; provider?: string; stakeFixtureId?: string; extId?: string; marketCount?: number; liveWidgetUrl?: string; widgetUrl?: string; streamExists?: boolean; customBetAvailable?: boolean; data: StakeFixtureData; tournament?: StakeTournament; eventStatus?: StakeFixtureEventStatus; markets?: StakeMarket[]; }
