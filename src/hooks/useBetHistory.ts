...
function betToHistoryRow(bet: BetRecord, outcomes: Array<{ marketName: string; fixtureName: string }>): BetHistoryRow {
    const matches = outcomes.length > 0
        ? [...new Set(outcomes.map((o) => o.fixtureName))]
        : ["Unknown fixture"];
