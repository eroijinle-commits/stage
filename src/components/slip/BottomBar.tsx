        ...
        <div className="h-12 shrink-0 border-t border-border bg-card px-3 flex items-center justify-between">
            <div className="flex items-center gap-4">
                <div className="flex flex-col leading-none">
                    <span className="text-[10px] font-mono text-muted-foreground uppercase tracking-wide">Bets</span>
                    <span className="text-xs font-mono font-semibold text-foreground tabular-nums">{selectionCount}</span>
                </div>
                <div className="flex flex-col leading-none">
                    <span className="text-[10px] font-mono text-muted-foreground uppercase tracking-wide">Total Stake</span>
            ...
            <div className="flex items-center gap-4">
                <div className="flex flex-col leading-none text-right">
                    <span className="text-[10px] font-mono text-muted-foreground uppercase tracking-wide">Return</span>
