...
import ScannerFilterBar, {
    type ScannerFilters,
} from "@/components/scanner/ScannerFilterBar";
                ...
                {isLoading ? (
                    ...
                    <>
                        ...
                        {flaggedResults.length > 0 && (
                            <span>{flaggedResults.length} matches</span>
                        )}
                        ...
                        {totalFixtures === 0 && !isLoading ? (
                            <>
                                ...
                                <p className="text-[10px] font-mono text-muted-foreground/60 max-w-xs">
                                    No {filters.sport} fixtures available for the selected date range. Try a
                                    different sport or widen the date range.
                                </p>
                            </>
                        ) : (
                            <>
                                ...
                                <p className="text-[10px] font-mono text-muted-foreground/60 max-w-xs">
                                    No markets exceed the {filters.minGapRatio}x gap threshold. Try lowering
                                    the threshold or changing the outcome count filter.
                                </p>
                            </>
                        )}
                    </div>
