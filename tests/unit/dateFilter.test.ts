...
describe("Fixture date filtering", () => {
  ...
  function filterByDateRange(items: typeof fixtures, from: string | null, to: string | null) {
  ...
  it("filters fixtures within date range", () => {
    const filtered = filterByDateRange(fixtures, "2026-08-25T00:00:00Z", "2026-08-26T23:59:59Z");
  ...
  it("returns empty for date range with no matches", () => {
    const filtered = filterByDateRange(fixtures, "2026-09-01T00:00:00Z", "2026-09-30T23:59:59Z");
    expect(filtered).toHaveLength(0);
  });

  it("handles start-of-day boundary correctly", () => {
    const filtered = filterByDateRange(fixtures, "2026-08-26T00:00:00Z", "2026-08-26T23:59:59Z");
