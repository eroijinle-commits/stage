                            ...
                            fixtureList: [
                                {
                                    ...
                                    data: {
                                        ...
                                        isOutright: false,
                                        competitors: [
                                            { name: "Arsenal", defaultName: "Arsenal", extId: "a1", countryCode: "GB", abbreviation: "ARS", iconPath: null, country: "England" },
                                            { name: "Chelsea", defaultName: "Chelsea", extId: "a2", countryCode: "GB", abbreviation: "CHE", iconPath: null, country: "England" },
                                        ],
                                        teams: [
                                ...
                                },
                                {
                                    ...
                                    data: {
                                        ...
                                        isOutright: false,
                                        competitors: [
                                            { name: "Liverpool", defaultName: "Liverpool", extId: "a3", countryCode: "GB", abbreviation: "LIV", iconPath: null, country: "England" },
                                            { name: "Man United", defaultName: "Man United", extId: "a4", countryCode: "GB", abbreviation: "MUN", iconPath: null, country: "England" },
                                        ],
                                        teams: [
                    ...
                    markets: [
                        {
                            ...
                            outcomes: [
                                ...
                                { id: "o2", name: "Draw", odds: 3.50, active: true },
                                { id: "o3", name: "Chelsea", odds: 4.20, active: true },
                            ],
                        },
                    ],
                },
                    ...
                    markets: [
                        {
                            ...
                            outcomes: [
                                ...
                                { id: "o5", name: "Under 2.5", odds: 2.10, active: true },
                            ],
                        },
                    ],
                },
            ...
            bets: [
                {
                    ...
                    outcomes: [
                        { id: "o1", name: "Arsenal", odds: 1.85, market: { name: "Match Winner" }, fixture: { name: "Arsenal vs Chelsea", slug: "arsenal-vs-chelsea" }, result: "win", status: "won" },
                    ],
                },
                {
                    id: "bet-002",
                    ...
                    potentialMultiplier: 5.20,
                    totalOdds: 5.20,
                    stakePerLeg: 2000,
                    createdAt: 1693228800000,
                    settledAt: 1693315200000,
                    outcomes: [
                        { id: "o2", name: "Liverpool", odds: 2.10, market: { name: "Match Winner" }, fixture: { name: "Liverpool vs Chelsea", slug: "liverpool-vs-chelsea" }, result: "win", status: "won" },
                        { id: "o3", name: "Over 2.5", odds: 2.48, market: { name: "Total Goals" }, fixture: { name: "Man City vs Arsenal", slug: "man-city-vs-arsenal" }, result: "loss", status: "lost" },
                    ],
                },
            ],
            totalCount: 2,
...
export function graphqlSuccess<T>(data: T) {
    return { ok: true, status: 200, statusText: "OK", json: () => Promise.resolve({ data }), headers: new Headers() };
}
